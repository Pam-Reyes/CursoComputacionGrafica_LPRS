...
int main() {
	...
	GLFWwindow *window = glfwCreateWindow(WIDTH, HEIGHT, "Practica4 Pamela Reyes", nullptr, nullptr);
	...
	float vertices[] = {
		...
		//Gris claro 
		 ...
		 //Beige
		-0.5f,  0.5f,  0.5f,  0.95f, 0.90f, 0.82f,
		-0.5f,  0.5f, -0.5f,  0.95f, 0.90f, 0.82f,
		-0.5f, -0.5f, -0.5f,  0.95f, 0.90f, 0.82f,
		-0.5f, -0.5f, -0.5f,  0.95f, 0.90f, 0.82f,
		-0.5f, -0.5f,  0.5f,  0.95f, 0.90f, 0.82f,
	...
	while (!glfwWindowShouldClose(window))
	{
	 ...
	 //   model = glm::mat4(1.0f);
		...
		model = glm::mat4(1.0f);
		model = glm::scale(model, glm::vec3(0.3f, 0.3f, 0.3f));//para que el cubo se vea más pequeño
		model = glm::translate(model, glm::vec3(-7.0f, -6.0f, -4.0f));
		model = glm::rotate(model, glm::radians(-90.0f), glm::vec3(0.0f, 1.0f, 0.0f)); //Para poder rotar el cubo en el angulo necesario para ver el color que se usara
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glDrawArrays(GL_TRIANGLES, 0, 36);
		...
		model = glm::mat4(1.0f);
		model = glm::scale(model, glm::vec3(0.3f, 0.3f, 0.3f));//para que el cubo se vea más pequeño
		model = glm::translate(model, glm::vec3(-7.0f, -5.0f, -4.0f));
		model = glm::rotate(model, glm::radians(-90.0f), glm::vec3(0.0f, 1.0f, 0.0f)); //Para poder rotar el cubo en el angulo necesario para ver el color que se usara
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glDrawArrays(GL_TRIANGLES, 0, 36);
		...
		model = glm::mat4(1.0f);
		model = glm::scale(model, glm::vec3(0.3f, 0.3f, 0.3f));//para que el cubo se vea más pequeño
		model = glm::translate(model, glm::vec3(-7.0f, -5.0f, -3.0f));
		model = glm::rotate(model, glm::radians(-90.0f), glm::vec3(0.0f, 1.0f, 0.0f)); //Para poder rotar el cubo en el angulo necesario para ver el color que se usara
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glDrawArrays(GL_TRIANGLES, 0, 36);
		...
		model = glm::mat4(1.0f);
		model = glm::scale(model, glm::vec3(0.3f, 0.3f, 0.3f));//para que el cubo se vea más pequeño
		model = glm::translate(model, glm::vec3(-6.0f, -4.0f, -3.0f));
		model = glm::rotate(model, glm::radians(-90.0f), glm::vec3(0.0f, 1.0f, 0.0f)); //Para poder rotar el cubo en el angulo necesario para ver el color que se usara
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glDrawArrays(GL_TRIANGLES, 0, 36);
		...
		model = glm::mat4(1.0f);
		model = glm::scale(model, glm::vec3(0.3f, 0.3f, 0.3f));//para que el cubo se vea más pequeño
		model = glm::translate(model, glm::vec3(-6.0f, -4.0f, -4.0f));
		model = glm::rotate(model, glm::radians(-90.0f), glm::vec3(0.0f, 1.0f, 0.0f)); //Para poder rotar el cubo en el angulo necesario para ver el color que se usara
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glDrawArrays(GL_TRIANGLES, 0, 36);
		...
		model = glm::mat4(1.0f);
		model = glm::scale(model, glm::vec3(0.3f, 0.3f, 0.3f));//para que el cubo se vea más pequeño
		model = glm::translate(model, glm::vec3(-7.0f, -4.0f, -3.0f));
		model = glm::rotate(model, glm::radians(-90.0f), glm::vec3(0.0f, 1.0f, 0.0f)); //Para poder rotar el cubo en el angulo necesario para ver el color que se usara
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glDrawArrays(GL_TRIANGLES, 0, 36);
		...
		model = glm::mat4(1.0f);
		model = glm::scale(model, glm::vec3(0.3f, 0.3f, 0.3f));//para que el cubo se vea más pequeño
		model = glm::translate(model, glm::vec3(-6.0f, -3.0f, -4.0f));
		model = glm::rotate(model, glm::radians(-90.0f), glm::vec3(0.0f, 1.0f, 0.0f)); //Para poder rotar el cubo en el angulo necesario para ver el color que se usara
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glDrawArrays(GL_TRIANGLES, 0, 36);
		...
		model = glm::mat4(1.0f);
		model = glm::scale(model, glm::vec3(0.3f, 0.3f, 0.3f));//para que el cubo se vea más pequeño
		model = glm::translate(model, glm::vec3(-7.0f, -2.0f, -4.0f));
		model = glm::rotate(model, glm::radians(-90.0f), glm::vec3(0.0f, 1.0f, 0.0f)); //Para poder rotar el cubo en el angulo necesario para ver el color que se usara
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glDrawArrays(GL_TRIANGLES, 0, 36);
		...
		model = glm::mat4(1.0f);
		model = glm::scale(model, glm::vec3(0.3f, 0.3f, 0.3f));//para que el cubo se vea más pequeño
		model = glm::translate(model, glm::vec3(-2.0f, -6.0f, -3.0f));
		model = glm::rotate(model, glm::radians(-90.0f), glm::vec3(0.0f, 1.0f, 0.0f)); //Para poder rotar el cubo en el angulo necesario para ver el color que se usara
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glDrawArrays(GL_TRIANGLES, 0, 36);
		...
		model = glm::mat4(1.0f);
		model = glm::scale(model, glm::vec3(0.3f, 0.3f, 0.3f));//para que el cubo se vea más pequeño
		model = glm::translate(model, glm::vec3(-3.0f, -6.0f, -3.0f));
		model = glm::rotate(model, glm::radians(-90.0f), glm::vec3(0.0f, 1.0f, 0.0f)); //Para poder rotar el cubo en el angulo necesario para ver el color que se usara
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glDrawArrays(GL_TRIANGLES, 0, 36);
		...
		model = glm::mat4(1.0f);
		model = glm::scale(model, glm::vec3(0.3f, 0.3f, 0.3f));//para que el cubo se vea más pequeño
		model = glm::translate(model, glm::vec3(-2.0f, -5.0f, -3.0f));
		model = glm::rotate(model, glm::radians(-90.0f), glm::vec3(0.0f, 1.0f, 0.0f)); //Para poder rotar el cubo en el angulo necesario para ver el color que se usara
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glDrawArrays(GL_TRIANGLES, 0, 36);
