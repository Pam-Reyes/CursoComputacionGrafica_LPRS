...
int main() {
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Practica 3 Pamela Reyes", nullptr, nullptr);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		//Segundo cubo - LetraA
		view = glm::translate(view, glm::vec3(4.0f, -3.1f, -12.0f));
		...
		//Primer cubo - Letra L
		model = glm::mat4(1);
		model = glm::translate(model, glm::vec3(-13.0f, -3.1f, -12.0f));
		model = glm::rotate(model, 12.0f, glm::vec3(0.0f, 1.0f, 0.0f));
